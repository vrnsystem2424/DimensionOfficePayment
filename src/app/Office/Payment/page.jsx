  ...
  const handleSubmit = async () => {
    ...
    try {
      for (const uid of selectedBills) {
        ...
        // ✅ BALANCE = PAID - TDS (+ roundoff)
        // This is the NET PAYABLE amount after TDS deduction
        ...
        await updateDimPayment({
          ...
          TDS_5:             tds || "",
          PAID_AMOUNT_5:     currentPaid,        // original paid amount
          BALANCE_AMOUNT_5:  netPayable,         // ✅ net payable after TDS
        ...
        <div>
          ...
          {filteredBills.length === 0 ? (
            ...
            filteredBills.map((bill) => {
              ...
              // ✅ BALANCE = PAID - TDS (+ roundoff)
              // This shows NET PAYABLE after TDS deduction
              const netPayable    = (currentPaid - tds) + roundup;
                  ...
                  {isSelected && (
                    <div style={{
                      ...
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr 1fr", gap: 16 }}>
                        ...
                        {/* 4. ✅ NET PAYABLE (Paid - TDS + RoundOff) */}
                        <div>
                          <label style={{ fontSize: 11, fontWeight: 700, color: "#64748b", display: "block", marginBottom: 6, letterSpacing: "0.07em" }}>
                            NET PAYABLE ₹
                          </label>
